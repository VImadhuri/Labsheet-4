...
public class MainActivity extends AppCompatActivity {
    ...
    //1.create channel id
    public static final String CHANNEL_ID = "mad";
    //2. create channel name
    public static final String CHANNEL_NAME = "Mad";
    //3. create channel description
    public static final String CHANNEL_DESCRIPTION = "Mad App Development";
